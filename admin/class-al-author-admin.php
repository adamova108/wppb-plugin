...
class Al_Author_Admin {
	...
	public function authors_metabox_save( int $post_id ) {
		...
		if (!empty($fname) && !empty($lname)) {
			...
			$wpdb->update($wpdb->posts, ['post_title' => "$fname $lname", 'post_name' => sanitize_title("$fname $lname")], ['ID' => $post_id]);
		}
	...
	public function authors_metabox_html( $post ) {
		...
		$al_author_gallery = isset($author_data['al_author_gallery']) ? $author_data['al_author_gallery'] : [];
					...
					<td>
						...
						<div id="al_author_profile_pic_wrapper">
							...
							if (isset($author_data['al_author_profile_pic']) 
								...
								echo wp_get_attachment_image($author_data['al_author_profile_pic'], 'thumbnail', false, ['class' => 'al_author_profile_pic_thumbnail']); 
