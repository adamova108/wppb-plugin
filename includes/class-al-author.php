...
class Al_Author {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Al_Author_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'AL_AUTHOR_VERSION' ) ) {
			$this->version = AL_AUTHOR_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'al-author';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-al-author-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-al-author-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-al-author-admin.php';
	 ...
	 *
	 * Uses the Al_Author_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Al_Author_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Al_Author_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Al_Author_Loader    Orchestrates the hooks of the plugin.
	 */
